...
<html>
	<head>
	    ...
	    Ext.onReady(function() {
			...
			var grid = Ext.create('Ext.grid.Panel', {
			    ...
			    columns: [
			        ...
			        {xtype: 'gridcolumn', text: '名称', dataIndex: 'name', align: 'center', width: '20%'},
			        {xtype: 'gridcolumn', text: '描述', dataIndex: 'description', align: 'center', width: '60%'},
			        {
			        	xtype: 'actioncolumn',
			        	text: '操作',
			        	menuDisabled: true,
	    ...
	    function deleteRecord(ids){
	    	Ext.Ajax.request({
   				url: '<%=request.getContextPath()%>/imageType/delete.html',
   				method: 'POST',
   				params: {id: ids},
		            ...
		            Ext.create('Ext.form.Panel', {
					    ...
					    buttons: [{
					        ...
					        handler: function() {
					            ...
					            if (form.isValid()) {
					                form.submit({
					                	url: '<%=request.getContextPath()%>/imageType/persist.html',
